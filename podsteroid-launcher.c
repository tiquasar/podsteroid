/*
 * podsteroid-launcher — sets PR_SET_PDEATHSIG before exec'ing QEMU.
 *
...
int main(int argc, char *argv[]) {
    if (argc < 2) {
        fprintf(stderr, "podsteroid-launcher: usage: launcher <qemu-path> [args...]\n");
        return 2;
    }
    ...
    perror("podsteroid-launcher: execv");
    return 127;
}
