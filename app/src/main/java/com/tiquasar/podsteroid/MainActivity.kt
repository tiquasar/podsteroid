...
import com.tiquasar.podsteroid.ui.navigation.NavGraphViewModel
import com.tiquasar.podsteroid.ui.navigation.PodsteroidApp
import com.tiquasar.podsteroid.ui.theme.PodsteroidTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val headlessVm: com.tiquasar.podsteroid.ui.HeadlessViewModel = hiltViewModel()
            ...
            PodsteroidTheme(darkTheme = darkTheme, dynamicColor = dynamicColor) {
                Surface(
                    modifier = Modifier.fillMaxSize(),
                    color = MaterialTheme.colorScheme.background,
                ) {
                    androidx.compose.foundation.layout.Box(Modifier.fillMaxSize()) {
                        PodsteroidApp(windowSizeClass = windowSizeClass)
                        if (headlessActive) {
                            com.tiquasar.podsteroid.ui.components.HeadlessOverlay(onExit = { headlessVm.disable() })
                        }
                    }
                }
            }
