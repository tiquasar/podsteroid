...
class AndroidNotificationPoster @Inject constructor(
    ...
    companion object {
        private const val CHANNEL_ID = "podsteroid_guest"
        // Guest notification ids live well above PodsteroidService.NOTIFICATION_ID (1001)
    ...
    init {
        ...
        ).apply { description = "Notifications sent from inside the VM (podsteroid-notify)" }
    ...
    override fun post(title: String?, body: String, priority: String, id: Int?): Int {
        ...
        val n = NotificationCompat.Builder(context, CHANNEL_ID)
            .setContentTitle(title ?: "Podsteroid")
            .setContentText(body)
