...
public final class TerminalEmulator {
    ...
    private void doDcs(final int b) {
        if (
            ...
            // PodSteroid: also flush on `$` (sixel CR) and `-` (sixel LF). The upstream sixel4
            ...
            // any flush-eligible byte arrived — see PodSteroid CLAUDE.md.
    ...
    private int[] getSixelDcsSetupArgs(String dcs, int index) {
        ...
        while (index < dcs.length()) {
            ...
            if (ch >= '0' && ch <= '9') {
                ...
                // PodSteroid: also accept `Pa;Pb;Pcq` form (no trailing `;` before `q`).
        ...
        switch (b) {
            ...
            case 'q':
                ...
                if (getArg0(0) == 0) {
                    ...
                    if (version == null || version.isEmpty()) version = "PodSteroid";
